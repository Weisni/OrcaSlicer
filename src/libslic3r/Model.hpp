...
public:
    ...
    // BBS
    static bool obj_import_color_deal(const std::vector<unsigned char>& filament_ids, std::optional<unsigned char> first_extruder_id, Model* model,
                                      std::function<bool(int)> deal_vertex_callback, std::function<int(int, int, int)> get_filament_id_callback = nullptr);
    ...
    static bool obj_import_vertex_color_deal(const std::vector<unsigned char>& vertex_filament_ids, std::optional<unsigned char> first_extruder_id,
                                             ModelVolume* volume, std::function<int(int, int, int)> get_filament_id_callback = nullptr);
    static bool obj_import_face_color_deal(const std::vector<unsigned char>& face_filament_ids, std::optional<unsigned char> first_extruder_id,
                                           ModelVolume* volume, std::function<int(int, int, int)> get_filament_id_callback = nullptr);
