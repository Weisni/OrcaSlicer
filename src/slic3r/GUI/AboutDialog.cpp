...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("QuackSlicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("QuackSlicer is based on OrcaSlicer, PrusaSlicer, and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "QuackSlicer_about_dark" : "QuackSlicer_about", 125);
    ...
    text_list.push_back(_L("QuackSlicer is a customized build of OrcaSlicer. It preserves OrcaSlicer's open-source heritage and compatibility while adding the QuackSlicer identity and project-specific features."));
